...
public class ParseErrorListenerEnabledRDFLoader {
     ...
     * @param vf
     */
    public ParseErrorListenerEnabledRDFLoader(ParserConfig config, ValueFactory vf) {
        this.config = config;
        this.vf = vf;
    }
        ...
        throws IOException, RDFParseException, RDFHandlerException
    {
        ...
        if (parseErrorListener == null) {
            parseErrorListener =new ParseErrorLogger(); 
        }
        rdfParser.setParseErrorListener(parseErrorListener);
