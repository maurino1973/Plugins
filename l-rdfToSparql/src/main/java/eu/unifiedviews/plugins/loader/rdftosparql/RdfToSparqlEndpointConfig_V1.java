 ...
 * @author Jiri Tomes
 */
public class RdfToSparqlEndpointConfig_V1 {
    ...
    public RdfToSparqlEndpointConfig_V1() {
    ...
    public RdfToSparqlEndpointConfig_V1(String SPARQL_endpoint, String Host_name,
            String Password,
