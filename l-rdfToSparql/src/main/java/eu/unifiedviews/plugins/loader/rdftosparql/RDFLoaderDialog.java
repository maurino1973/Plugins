...
public class RDFLoaderDialog extends BaseConfigDialog<RDFLoaderConfig> {
     ...
     * 
     * @param type
     *            Type of load RDF data to named graph: OVERRIDE, MERGE or FAIL
     ...
     * 
     * @param type
     *            Type of insert data parts: {@link LoaderPostType#POST_UNENCODED_QUERY} or {@link LoaderPostType#POST_URL_ENCODER} or
     ...
     * endpoint: Uses in {@link #setConfiguration} for setiing {@link #dataPartsOption}
     * 
     * @param type
     *            Type of insert data parts: {@link InsertType#SKIP_BAD_PARTS} or {@link InsertType#STOP_WHEN_BAD_PART}
     * @return description that corresponds to specific type or ""
     */
     ...
     * POST_URL_ENCODER, POST_UNENCODED_QUERY or POST_VIRTUOSO_SPEFIC. Uses in {@link #getConfiguration} for determine the type by description that
     * located in {@link #postTypeOption}
     * 
     * @param desc
     *            String with description of chosed way, how to loading RDF
     *            data to SPARQL endpoint. One value from {@link #postTypeOption}
     * @return type that corresponds to desc or {@link LoaderPostType#POST_URL_ENCODER} in case of absence.
     */
    ...
    /**
     * Get type of load RDF data to named graph: OVERRIDE, MERGE or FAIL Uses in {@link #getConfiguration} for determine the type by description that
     * located in {@link #optionGroupDetail}
     * 
     * @param desc
     *            String with description of chosed way, how to load RDF data
    ...
    /**
     * Get type of insert RDF data part to SPARQL endpoint: {@link InsertType#SKIP_BAD_PARTS} or {@link InsertType#STOP_WHEN_BAD_PART}. Uses in
     * {@link #getConfiguration} for determine the type by description that located in {@link #dataPartsOption}
     * 
     * @param desc
     *            String with description of chosed way, how to load RDF data
...
//        dataPartsOption.addItem(skip.getDescription());
     ...
     * and buttons for add and remove this textfields. Used in {@link #initializeNamedGraphList} and also in adding and removing fields
